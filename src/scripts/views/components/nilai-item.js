class NilaiItem extends HTMLElement {
  set nilai(data) {
  ...
  render() {
    ...
    if (NILAI_PENGETAHUAN !== null && NILAI_KETERAMPILAN !== null) {
...
customElements.define('nilai-item', NilaiItem);
